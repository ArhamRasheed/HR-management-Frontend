...
//   // Mock data for new features (replace with real API data when available)
...
//   const mockNewHires = [
//     { id: 1, name: 'Alice Johnson', department: 'Engineering', joinDate: '2024-11-15', initials: 'AJ' },
//     { id: 2, name: 'Bob Smith', department: 'Marketing', joinDate: '2024-11-18', initials: 'BS' },
//     { id: 3, name: 'Carol White', department: 'Finance', joinDate: '2024-11-19', initials: 'CW' },
//     { id: 4, name: 'David Brown', department: 'HR', joinDate: '2024-11-20', initials: 'DB' },
//   ];

//   const mockPendingLeaves = [
//     { id: 1, employeeName: 'John Doe', leaveType: 'Sick Leave', dateRange: 'Nov 22 - Nov 24', days: 3 },
//     { id: 2, employeeName: 'Jane Smith', leaveType: 'Annual Leave', dateRange: 'Nov 25 - Nov 30', days: 6 },
//     { id: 3, employeeName: 'Mike Johnson', leaveType: 'Casual Leave', dateRange: 'Nov 23', days: 1 },
//     { id: 4, employeeName: 'Sarah Wilson', leaveType: 'Annual Leave', dateRange: 'Dec 1 - Dec 5', days: 5 },
//   ];
...
//     { department: 'Sales', employees: 38 },
//     { department: 'Operations', employees: 32 },
//   ];

//   const payrollData = [
//     { name: 'Engineering', value: 3500000 },
//     { name: 'Marketing', value: 2100000 },
//     { name: 'Finance', value: 1800000 },
//     { name: 'HR', value: 1200000 },
//     { name: 'Sales', value: 2850000 },
//     { name: 'Operations', value: 1000000 },
//   ];
...
//             <p className="text-sm text-gray-500">{present} Present • {absent} Absent</p>
//           </div>
...
//         <AttendanceDonut present={215} absent={32} />
...
//               New Hires This Month
//             </h3>
//             <span className="text-sm text-gray-500">{mockNewHires.length} employees</span>
//           </div>
...
//                 </div>
//                 <div className="flex-1">
//                   <p className="font-semibold text-gray-800 text-sm">{hire.name}</p>
//                   <p className="text-xs text-gray-500">{hire.department}</p>
//                 </div>
//                 <div className="text-right">
//                   <p className="text-xs text-gray-600">{hire.joinDate}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//               {mockPendingLeaves.length} Pending
//             </span>
//           </div>
//           <div className="space-y-3 max-h-80 overflow-y-auto">
...
//                 </div>
//                 <p className="text-xs text-gray-500 mb-2">{leave.dateRange}</p>
...
//             <span className="text-sm text-gray-500">Total: {departmentData.reduce((acc, d) => acc + d.employees, 0)}</span>
//           </div>
...
//             <p className="text-3xl font-bold text-gray-900">PKR 12,450,000</p>
